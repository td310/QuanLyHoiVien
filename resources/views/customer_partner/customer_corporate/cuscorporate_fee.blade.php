...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="title-alta">Lịch sử hội phí</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-8">
                                            <p>{{format_money($corporate->total_debt)}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="d-flex align-items-center justify-content-between p-4">
                            <form action="{{ route('fees.customer_corporate', $corporate->id) }}" method="GET">
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @forelse($corporate->memFees as $memFee)
                                        <tr>
