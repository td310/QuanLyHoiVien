                    ...
                    <div class="card">
                        ...
                        <form action="{{ route('store.market') }}" method="POST">
                                            ...
                                            <div class="row align-items-center mb-2">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="market_name"
                                                        value="{{ $market->market_name }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row align-items-center mb-2">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="market_id"
                                                        value="{{ $market->market_id }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="row align-items-center mb-2">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control" name="description" readonly>{{ $market->description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer d-flex justify-content-center">
                                <a href="{{ route('edit.market', $market->id) }}" class="btn btn-primary mr-2">Chỉnh sửa</a>
